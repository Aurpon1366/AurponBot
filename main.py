...
# ================== Configuration ==================
class Config:
    TOKEN = os.environ.get('BOT_TOKEN', '8737233153:AAGghl2sAfzlfW1t6giAvX5n0R-7AK90IUc')
...
if __name__ == '__main__':
    ...
    app.run(host='0.0.0.0', port=Config.PORT)    with open(DB_FILE, "wb") as f: pickle.dump(file_db, f)
